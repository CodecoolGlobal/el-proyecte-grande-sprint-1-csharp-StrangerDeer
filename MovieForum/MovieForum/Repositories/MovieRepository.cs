...
public class MovieRepository : IMovieRepository<Movie>
{
    ...
    {
        return _movies.FirstOrDefault(movie => movie != null && movie.Id.Equals(Guid.Parse(id)));
    }

    public void DeleteMovieById(string id)
    {
        var movieToDelete = _movies.FirstOrDefault(movie => movie != null && movie.Id.Equals(Guid.Parse(id)));
    ...
    {
        var movieToUpdate = _movies.FirstOrDefault(movie => movie != null && movie.Id.Equals(Guid.Parse(id)));
